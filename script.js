...
const projects = [
  {
    ...
    screenshot: "public/projects/yaarnies-camera-store.svg",
    liveUrl: "https://example.com",
    repoUrl: "https://github.com/yeboaheric",
    techStack: ["Next.js", "React", "Tailwind CSS", "TypeScript"],
    features: [
      { label: "Responsive e-commerce platform", icon: "monitor" },
      { label: "Real-time inventory management", icon: "package" },
      { label: "Secure booking flow", icon: "shield-check" },
    ],
  },
  {
    title: "SkillExchange",
    description: "A community product concept for discovering people, trading knowledge, and arranging skill sessions.",
    screenshot: "public/projects/skillexchange.svg",
    liveUrl: "https://example.com",
    repoUrl: "https://github.com/yeboaheric",
    techStack: ["Next.js", "TypeScript", "Supabase", "PostgreSQL"],
    features: [
      { label: "Marketplace users", icon: "users" },
      { label: "Messaging flow", icon: "message-circle" },
      { label: "Responsive platform", icon: "monitor" },
    ],
  },
  {
    ...
    screenshot: "public/projects/adwoa-fosua-saas.svg",
    liveUrl: "https://example.com",
    repoUrl: "https://github.com/yeboaheric",
    techStack: ["Next.js", "React", "Tailwind CSS", "Framer Motion", "Vercel"],
    features: [
      { label: "Inventory system", icon: "package" },
      { label: "Reusable admin modules", icon: "boxes" },
      { label: "Payment-ready structure", icon: "shield-check" },
    ],
  },
];
